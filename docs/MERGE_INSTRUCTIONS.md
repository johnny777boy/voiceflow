...
- [x] Internal verification passes (`swift build` clean, `swift run VoiceFlowTests` → 79/79).
...
Expect `Build complete!` (0 warnings) and `✓ All 79 tests passed.`
...
- 79 passing tests; 0 build warnings under Swift 6 strict concurrency.

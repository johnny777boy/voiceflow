...
|-------------|:------:|----------|
| System-wide shortcut | ✅ code-complete | `GlobalHotkeyManager` (CGEvent tap, push-to-talk + toggle). Requires Accessibility permission at runtime. |
...
all 72 automated tests pass, the release `.app` bundles and signs, and a
